...
------------      03-02-2023 RDB & SQL Course Project Session    ------------

/*
E-Commerce Data and Customer Retention Analysis with SQL
_________________________________________________________
An e-commerce organization demands some analysis of sales and shipping processes. Thus, the organization hopes to be able to predict more easily the opportunities and threats for the future. Acording to this scenario, You are asked to make the following analyzes consistant with following the instructions given. 
...
--2. Find the customer whose order took the maximum time to get delivered.
...
SELECT	DATENAME(MONTH, Order_Date) ORD_MONTH, MONTH(order_date) ord_month_2 , COUNT (DISTINCT CTE.Cust_id) CNT_CUST
FROM	combined_table A, CTE 
